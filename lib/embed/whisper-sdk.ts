...
function parseBool(v,d){if(v==null||v==='')return d;return v!=='false'&&v!=='0';}
...
var theme=attr(sc,'data-theme','system');
var accent=attr(sc,'data-accent','#06b6d4');
var position=attr(sc,'data-position','bottom-right');
var label=attr(sc,'data-label','Send Feedback');
var sessionOn=parseBool(attr(sc,'data-session-timeline',null),true);
var deviceMeta=parseBool(attr(sc,'data-device-metadata',null),true);
var secAttr=attr(sc,'data-session-seconds',null);
